...
export default function AboutSection() {
  const teamMembers = [
    { name: 'Diana Ruiz Moctezuma', role: 'Data Analyst', initial: 'DR' },
    { name: 'Ruben Omar Rodriguez Carrillo', role: 'Desarrollador Frontend', initial: 'RR' },
    { name: 'Joel Kaleb Moreno Valenzuela', role: 'Desarrollador Backend / Infraestructura', initial: 'JM' },
    { name: 'Alejandro Corona Jimenez', role: 'Desarrollador Backend', initial: 'AC' },
  ];

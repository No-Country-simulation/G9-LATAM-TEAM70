...
export default function Footer() {
  const teamMembers = [
    {
      name: 'Diana Ruiz Moctezuma',
      role: 'Data Analyst',
      initial: 'DR',
      description: 'Análisis y preparación de datos para el modelo de clasificación.',
      linkedin: 'https://linkedin.com/in/',
      github: 'https://github.com/',
    },
    {
      name: 'Ruben Omar Rodriguez Carrillo',
      role: 'Desarrollador Frontend',
      initial: 'RR',
      description: 'Diseño e implementación de la interfaz web de TechMind.',
      linkedin: 'https://linkedin.com/in/',
      github: 'https://github.com/',
    },
    {
      name: 'Joel Kaleb Moreno Valenzuela',
      role: 'Desarrollador Backend / Infraestructura',
      initial: 'JM',
      description: 'Desarrollo de servicios backend e infraestructura de despliegue.',
      linkedin: 'https://linkedin.com/in/',
      github: 'https://github.com/',
    },
    {
      ...
      initial: 'AC',
      description: 'Desarrollo e integración de los servicios backend.',
      linkedin: 'https://linkedin.com/in/',
      github: 'https://github.com/',
    },
  ];
          ...
          <Card className="bg-wisteria/15 border-none text-primary shadow-lg rounded-2xl backdrop-blur-md">
            <CardContent className="p-6 space-y-3">
              ...
              <p className="text-xs text-secondary leading-relaxed">
                API RESTful encargada del manejo de persistencia JPA, clasificación inteligente de contenido y exposición de endpoints multipart/file.
              </p>
            </CardContent>
          </Card>
